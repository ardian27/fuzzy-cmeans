...
class NilaiController extends Controller
{
    ...
    {    
        ...
        {
            $id_nilai  = Yii::$app->request->post('editableKey');
            
            $nilai = Nilai::findOne($id_nilai);
    ...
    public function actionDataNilai($id)
    {    
        $searchModel = new NilaiSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        ...
        $data= Nilai::find(['nim'=>$id])->all();
        $dataProvider ->query->where(['nim' => $id]);
    ...
    /**
     * Delete an existing Nilai model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Nilai model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
